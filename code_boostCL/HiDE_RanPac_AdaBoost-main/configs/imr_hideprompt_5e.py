...
def get_args_parser(subparsers):
    ...
    subparsers.add_argument('--no-pin-mem', action='store_false', dest='pin_mem',
                            help='')
    subparsers.add_argument('--wols', action='store_true', help='Perform special tunning cls-head')
    subparsers.add_argument('--num_view', type=int, default=1, help='Num of views for classification')
