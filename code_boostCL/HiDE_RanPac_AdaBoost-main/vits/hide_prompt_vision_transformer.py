...
class VisionTransformer(nn.Module):
    ...
    def forward_features(self, x, task_id=-1, prompt_id=None, prompt_weight=None, train=False, prompt_momentum=0):
        ...
        # print(self.class_token, self.head_type, self.prompt_pool, self.total_prompt_len)

        return res

    def forward_head(self, res, pre_logits: bool = False):
        x = res['x']
        # print('head', x.shape, x[:, self.total_prompt_len].shape, x[:, 0].shape, self.total_prompt_len)
